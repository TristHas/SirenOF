...
Classical approaches formulate assumptions such as constant speed or acceleration of the optical flow between consecutive frames [CITE].
...
\begin{itemize}
\item Optical flow is prone to errors due to obstructions and illumination variations unrelated to the motion field. % Check me
\item Assumptions of constant first or second derivatives of the flow directions do not necessarily hold in practice. % Check me
\end{itemize}
